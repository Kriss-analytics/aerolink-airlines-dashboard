AeroLink Airlines Performance Dashboard (Excel)

A compact Excel dashboard project analyzing AeroLink Airlines’ operational performance across major Nigerian cities from January to June 2025. The dataset was provided as part of a guided learning project (Nebiant Analytics), used to build an interactive dashboard for business insight generation.
